...
<head>
    ...
    <meta name="author" content="Marlon Mena" />
    <!--[if IE]>
       ...
       <form class="form-horizontal" role="form" id="datos_presupuesto" method="post">
        <div id="print-area">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                  <center><a href="https://marlon.mena.pw/" target="_blank">  <img src="assets/img/logo.jpg" width="140" height="100" alt="Logo sistemas web" /></a></center>
			...
			<hr />
                <div class="col-lg-6 col-md-6 col-sm-6">
                	<button type="button" class="btn btn-success"><a href="index.php"><font color="white">Regresar Home</font></a></button>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    ...
                    <textarea  class="form-control" id="descripcion" name="descripcion"  required placeholder="Ingresa la descripción del presupuesto" ></textarea>
                        ...
                        <table class="table table-striped  table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class='text-right'>Total + IVA 16 %</th>
