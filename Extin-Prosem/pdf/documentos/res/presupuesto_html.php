...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <?php echo "marlon.mena.pw "; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
    <table cellspacing="0" style="width: 100%;">
        <tr>
            ...
            <td  style="width: 33%; color: #444444;">
                <img style="width: 100%;" src="../../assets/img/logo.jpg" width="140" height="100" alt="Logo"><br>
	...
	<table cellspacing="0" style="width: 100%;" class='items'>
        <tr>
			...
			<th style="text-align:right;width:20%">Total + iva 16%</th>
        </tr>
	<?php
		...
		while($row=mysqli_fetch_array($query)){
			$total=($row['cantidad']*$row['precio']) + ($row['cantidad']*$row['precio']*16/100);
	...
	?>	
	<tr >
		<td colspan=3 class='text-right' style="font-size:24px;color: #3498db">TOTAL MX </td>
	...
	<table cellspacing="0" style="width: 100%;" class="detalle">
		...
		<tr>
			<td style="width: 100%;">
			<strong>Nota:</strong> * Somos una empresa verificada con núm. de DICTAMEN VENCE1020035
			<br>
			* Contamos con servicio de fumigación.
			<br>
			* De igual manera garantizamos la recarga de los extintores Cumpliendo con la NOM 154 STPS, colocando el collarín y holograma.
			<br>
			* El costo de la recarga y mantenimiento incluye: instalación, capacitación en el uso y manejo de extintores, constancia y reconocimiento a la empresa, supervisión de los equipos cada cuatro meses. Garantía en la recarga de un año siempre que tenga el perno o seguro y el equipo no haya vencido.
			</td>
